...
一个面向 AI Agent（Kimi Work / Claude Code 等支持 Skills 的运行时）的可复用 Skill：**把 PPT 学习内容"演绎"成一篇自包含的理解型 Markdown 笔记。**

产出不是 PPT 的镜像摘要，而是一位聪明人学完后独立写出的重构笔记——第三方仅凭该笔记即可完整、准确地讲解原 PPT 的全部要点与逻辑。
